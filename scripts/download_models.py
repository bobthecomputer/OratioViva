#!/usr/bin/env python
"""
Download TTS models locally for OratioViva (Tauri app).

Examples:
  python scripts/download_models.py --dest %LOCALAPPDATA%\OratioViva\models
  python scripts/download_models.py --models kokoro parler --dest my_models

The default location for bundled models is %LOCALAPPDATA%\OratioViva\models.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Telecharge les modeles TTS necessaires en local."
    )
    parser.add_argument(
        "--dest",
        default="models",
